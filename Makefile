...
install-local: build
	...
	cp bin/expand bin/link bin/unlink bin/new-password bin/info bin/expose bin/unexpose bin/promote bin/failover bin/rejoin bin/psql bin/backup bin/restore bin/help \
